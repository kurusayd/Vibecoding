...
export const UNIT_CATALOG = [
  ...
  { race: 'HUMAN',  type: 'Priest',         label: 'PRIEST',          powerType: POWER_TYPE_BISHOP, hp: 96,  atk: 22, attackSpeed: 0.6, moveSpeed: 0.9, attackRangeMax: 20, attackRangeFullDamage: 5, projectileSpeed: 6.0, attackMode: ATTACK_MODE_RANGED, armor: 1, magicResist: 20, abilityType: ABILITY_PASSIVE, abilityKey: 'priest_heal' },
  ...
  { race: 'UNDEAD', type: 'Zombie',         label: 'ZOMBIE',          powerType: POWER_TYPE_KNIGHT, hp: 105, atk: 24, attackSpeed: 0.65, moveSpeed: 0.9, attackRangeMax: 1,  attackRangeFullDamage: 1, projectileSpeed: 0, attackMode: ATTACK_MODE_MELEE, armor: 8, magicResist: 0, abilityType: ABILITY_PASSIVE, abilityKey: 'zombie_self_destruct', abilityCooldown: 3, abilityDamageType: DAMAGE_TYPE_PHYSICAL },
