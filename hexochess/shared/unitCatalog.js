...
export const UNIT_CATALOG = [
  ...
  { race: 'HUMAN',  type: 'Priest',         label: 'PRIEST',          powerType: POWER_TYPE_BISHOP, hp: 60,  atk: 20, attackSpeed: 1.3, moveSpeed: 0.9, attackRangeMax: 20, attackRangeFullDamage: 5 },
  ...
  { race: 'HUMAN',  type: 'Crossbowman',    label: 'CROSSBOW',        powerType: POWER_TYPE_PAWN,   hp: 40,  atk: 25, attackSpeed: 1.6, moveSpeed: 1.0, attackRangeMax: 20, attackRangeFullDamage: 5 },
  { race: 'HUMAN',  type: 'Crusader',       label: 'CRUSADER',        powerType: POWER_TYPE_KNIGHT, hp: 120, atk: 12, attackSpeed: 0.9, moveSpeed: 1.1, attackRangeMax: 1,  attackRangeFullDamage: 1 },
  { race: 'UNDEAD', type: 'BonesGolem',     label: 'BONES GOLEM',     powerType: POWER_TYPE_BISHOP, hp: 240, atk: 12, attackSpeed: 0.7, moveSpeed: 0.8, attackRangeMax: 1,  attackRangeFullDamage: 1 },
  { race: 'UNDEAD', type: 'Ghost',          label: 'GHOST',           powerType: POWER_TYPE_KNIGHT, hp: 120, atk: 12, attackSpeed: 1.4, moveSpeed: 2.4, attackRangeMax: 2,  attackRangeFullDamage: 2 },
  { race: 'UNDEAD', type: 'Lich',           label: 'LICH',            powerType: POWER_TYPE_BISHOP, hp: 120, atk: 12, attackSpeed: 1.2, moveSpeed: 1.0, attackRangeMax: 20, attackRangeFullDamage: 5 },
  { race: 'UNDEAD', type: 'SkeletonArcher', label: 'SKELETON ARCHER', powerType: POWER_TYPE_PAWN,   hp: 120, atk: 12, attackSpeed: 1.3, moveSpeed: 1.0, attackRangeMax: 20, attackRangeFullDamage: 5 },
  { race: 'UNDEAD', type: 'Vampire',        label: 'VAMPIRE',         powerType: POWER_TYPE_BISHOP, hp: 120, atk: 12, attackSpeed: 1.1, moveSpeed: 2.0, attackRangeMax: 1,  attackRangeFullDamage: 1 },
