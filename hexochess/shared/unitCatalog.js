...
export const UNIT_CATALOG = [
  ...
  { race: 'LIZARD', type: 'NagaSiren',      label: 'NAGA SIREN',      powerType: POWER_TYPE_BISHOP, hp: 120, atk: 12, attackSpeed: 0.95, moveSpeed: 1.3, attackRangeMax: 1,  attackRangeFullDamage: 1, projectileSpeed: 0, attackMode: ATTACK_MODE_MELEE },
  ...
  { race: 'HUMAN',  type: 'Crossbowman',    label: 'CROSSBOW',        powerType: POWER_TYPE_PAWN,   hp: 40,  atk: 25, attackSpeed: 0.8, moveSpeed: 1.2, attackRangeMax: 20, attackRangeFullDamage: 5, projectileSpeed: 20.0, attackMode: ATTACK_MODE_RANGED, abilityType: ABILITY_PASSIVE, abilityKey: 'crossbowman_line_shot' },
  ...
  { race: 'HUMAN',  type: 'Knight',         label: 'KNIGHT',          powerType: POWER_TYPE_ROOK,   hp: 120, atk: 12, attackSpeed: 1.0, moveSpeed: 2.0, attackRangeMax: 1,  attackRangeFullDamage: 1, projectileSpeed: 0, attackMode: ATTACK_MODE_MELEE, cellSpanX: 2, abilityType: ABILITY_ACTIVE, abilityKey: 'knight_charge', abilityCooldown: 6 },
  ...
  { race: 'UNDEAD', type: 'Worm',           label: 'WORM',            powerType: POWER_TYPE_QUEEN,  hp: 480, atk: 24, attackSpeed: 1, moveSpeed: 3.0, attackRangeMax: 1,  attackRangeFullDamage: 1, projectileSpeed: 0, attackMode: ATTACK_MODE_MELEE, cellSpanX: 2, abilityType: ABILITY_PASSIVE, abilityKey: 'worm_swallow', abilityCooldown: 6 },
  ...
  { race: 'UNDEAD', type: 'Zombie',         label: 'ZOMBIE',          powerType: POWER_TYPE_KNIGHT, hp: 120, atk: 12, attackSpeed: 0.8, moveSpeed: 0.9, attackRangeMax: 1,  attackRangeFullDamage: 1, projectileSpeed: 0, attackMode: ATTACK_MODE_MELEE },
